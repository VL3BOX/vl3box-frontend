    ...
    var openDialog = function () {
        return editor.windowManager.open({
            ...
            onSubmit: function (api) {
                ...
                // 将输入框内容插入到内容区光标位置
                editor.insertContent(`<iframe class="w-player-bilibili" src="//player.bilibili.com/player.html?bvid=${videox}&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>`);
                api.close();
            },
        });
    };
