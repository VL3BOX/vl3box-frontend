    ...
    build: {
        ...
        rollupOptions: {
            input: {
                ...
                face: resolve(root, "./templates/face/index.html"),
                body: resolve(root, "./templates/body/index.html"),
                homeland: resolve(root, "./templates/homeland/index.html"),
                pet: resolve(root, "./templates/pet/index.html"),
                adventure: resolve(root, "./templates/adventure/index.html"),
                horse: resolve(root, "./templates/horse/index.html"),
                book: resolve(root, "./templates/book/index.html"),
                furniture: resolve(root, "./templates/furniture/index.html"),
                reputation: resolve(root, "./templates/reputation/index.html"),
                pvg: resolve(root, "./templates/pvg/index.html"),
                exam: resolve(root, "./templates/exam/index.html"),
                exterior: resolve(root, "./templates/exterior/index.html"),
            },
            output: {
                manualChunks(id) {
        ...
        },
        {
            ...
            configureServer(server) {
                ...
                server.middlewares.use((req, res, next) => {
                    if (req.url === '/exterior') {
                        req.url = '/templates/exterior/index.html';
                    }
                    next();
                });
            },
