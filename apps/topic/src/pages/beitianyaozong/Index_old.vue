                    ...
                    <div class="wp">
                        ...
                        <div class="m-pv-box m-pve-box">
                            <div class="m-fb-left">
                                ...
                                <text-list-y :data="data.fb_posts" :length="6" :withAuthor="true"></text-list-y>
                    ...
                    <div class="wp">
                        ...
                        <div class="m-pv-box m-pvx-box">
                            ...
                            <div class="m-pvx-right">
                                ...
                                <text-list-y :data="data.pvx_posts" :length="5"></text-list-y>
                                <img-matrix
                                    class="u-pics"
...
import slider_a from "@/components/common/slider_a.vue";
import slider_b from "@/components/common/slider_b.vue";
import img_matrix from "@/components/common/img_matrix.vue";
import img_list_x from "@/components/common/img_list_x.vue";
import img_list_y from "@/components/common/img_list_y.vue";
import img_single_link from "@/components/common/img_single_link.vue";
// import img_single_simple from "@/components/common/img_single_simple.vue";
import yaozong_skill from "./yaozong_skill.vue";
import text_list_y from "@/components/common/text_list_y.vue";
export default {
    name: "Topic",
    props: [],
    components: {
...
<style lang="less" >
@import "../../assets/css/beitianyaozong/common.less";
@import "../../assets/css/beitianyaozong/old.less";
</style>