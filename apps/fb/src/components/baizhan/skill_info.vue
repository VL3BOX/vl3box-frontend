<template>
    <div class="m-skill-info">
        ...
        <div class="u-skill-item">
            <div class="u-item-title">Nguồn rơi</div>
            <div class="u-item-content">
                ...
                <div class="u-name" :class="!skill.szBossName && 'u-no-name'">{{ skill.szBossName || "Không xác định" }}</div>
            </div>
        </div>
        <div class="u-skill-item">
            <div class="u-item-title">Thông tin kỹ năng</div>
            <div class="u-list">
                <div class="u-info u-cost">
                    <span class="u-label">Chiếm dụng</span>
                ...
                <div class="u-info u-pz" v-if="skill.nColor">
                    <span class="u-label">Khe hở</span>
        ...
        <div class="u-skill-btn" @click="getUrl">Xem dữ liệu chi tiết</div>
    </div>
</template>
