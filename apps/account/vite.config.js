...
// import vue from 'vite-plugin-vue2';  // For Vue 2 support
// import legacy from '@vitejs/plugin-legacy';  // For IE11 and older browser support
...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        login: resolve(root, './templates/login/index.html'),
        register: resolve(root, './templates/register/index.html'),
        login_callback: resolve(root, './templates/login_callback/index.html'),
        password_reset: resolve(root, './templates/password_reset/index.html'),
      },
      output: {
        manualChunks(id) {
