<template>
    <div class="m-single-box">
        ...
        <div class="m-single-append">
            ...
            <PostGuide class="m-single-guide" :post="post" />
            ...
            <div ref="commentView" class="m-single-comment">
                <el-divider content-position="left">Bình luận</el-divider>
                <!-- <template v-if="showComment"> -->
                    <Comment :id="id" category="post" v-if="id && allow_comment" />
                    <el-alert title="作者没有开启Bình luận功能" type="warning" show-icon v-else></el-alert>
                <!-- </template> -->
                <!-- <el-alert title="作者开启了Bình luận仅自己可见" type="warning" show-icon v-else></el-alert> -->
            </div>
        </div>
