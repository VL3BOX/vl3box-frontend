...
export default {
    ...
    data() {
        return {
            jingmai: [
                { name: "Đốc mạch·腰俞", id: 92, lnLevel: 2 },
                { name: "Đốc mạch·脊中", id: 95, lnLevel: 2 },
                { name: "Đốc mạch·灵台", id: 99, lnLevel: 2 },
                { name: "Đốc mạch·大椎", id: 112, lnLevel: 2 },
                { name: "Đốc mạch·脑户", id: 115, lnLevel: 0 },
            ],
            mouseData: {},
            hover: "",
        };
