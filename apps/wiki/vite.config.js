...
export default defineConfig({
    ...
    publicDir: "public",
    build: {
        sourcemap: false, // TODO: Conflict with `svg-url-replace` plugin
        ...
        rollupOptions: {
            input: {
                ...
                cj: resolve(root, './templates/cj/index.html'),
                item: resolve(root, './templates/item/index.html'),
                knowledge: resolve(root, './templates/knowledge/index.html'),
                quest: resolve(root, './templates/quest/index.html'),
                macro_details: resolve(root, './templates/macro/details/index.html'),
                macro_top: resolve(root, './templates/macro/tops/index.html'),
            },
            output: {
                manualChunks(id) {
    ...
    resolve: {
        alias: {
            ...
            // "~@jx3box/jx3box-editor": path.resolve(__dirname, "./node_modules/@jx3box/jx3box-editor"),
        },
