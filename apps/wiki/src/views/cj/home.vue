    ...
    <div class="m-home-view">
        ...
        <WikiPanel :border-none="true">
            <template slot="head-title">
                ...
                <span>Thành tựu mới nhất</span>
            </template>
            <template slot="head-actions">
                <router-link class="other" :to="{ name: 'newest' }">Xem thêm &raquo;</router-link>
            </template>
            <template slot="body">
