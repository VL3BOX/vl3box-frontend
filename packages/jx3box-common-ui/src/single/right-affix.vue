<template>
    <div class="c-right-affix" :class="{ 'is-close': !isOpen }">
        ...
        <el-tooltip v-if="showComment" effect="dark" content="Đi đến bình luận" placement="left">
            <div class="u-item" @click="toComment">
                <i class="el-icon-chat-dot-square"></i>
            </div>
        </el-tooltip>
        <el-tooltip effect="dark" content="Quay về đầu trang" placement="bottom">
...
export default {
    ...
    mounted() {
        ...
        window.addEventListener("scroll", function () {
            ...
            //Quay về đầu trang过程中用户滚动滚动条，停止定时器
            if (!self.isTop) {
                clearInterval(self.scrollToptimer);
            }
            self.isTop = false;
