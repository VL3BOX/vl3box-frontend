    ...
    >
        <div class="c-item-wrapper">
            ...
            <div
                ...
                v-text="'Môn phái đề xuất:' + source.Recommend"
            ></div>
            <!-- 冷却时间 -->
            <div
            ...
            <div
                ...
                v-text="'Ngoại hình:' + source.CanExterior"
            ></div>
            <!-- 储物箱共享 -->
            <div
                v-if="
                ...
                "
                class="u-can-shared"
            >Vật phẩm này có thể được đặt vào kho tài khoản để chia sẻ.</div>
            <div
                v-if="
                    source.CanShared &&
                        source.AucGenre >= 1 &&
                ...
                "
                class="u-can-shared"
            >Trang bị này có thể được đặt vào kho tài khoản để chia sẻ trước khi được tinh luyện, tương khảm, phụ ma, mặc vào.</div>
